...
class JVideo_VideoCategoryFactory
{
    public static function create($videoId, $categoryId, $name = "", $nestLeft = "", 
        $nestRight = "", $breadcrumb = "", $videoGuid = "")
    {
        $videoCategory = new JVideo_VideoCategory();
        $videoCategory->videoId = $videoId;
        $videoCategory->videoGuid = $videoGuid;
        $videoCategory->categoryId = $categoryId;
        $videoCategory->name = $name;
        $videoCategory->nestLeft = $nestLeft;
        $videoCategory->nestRight = $nestRight;
        $videoCategory->breadcrumb = $breadcrumb;
