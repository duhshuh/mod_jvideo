...
class JVideo_VideoRepositoryFactory
{
	public static function &create()
	{
        ...
        {
            $repositories = new JVideo_CompositeVideoRepository();

            $repositories->add(new JVideo_JoomlaVideoRepository());
            $repositories->add(new JVideo_WarpVideoRepository());
        }
