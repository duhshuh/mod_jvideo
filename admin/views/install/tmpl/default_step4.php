...
<form action="index.php" method="post" id="adminForm" name="adminForm">
    ...
    <h1><?php echo JText::_("JV_INSTALL_STEP_4"); ?></h1>

    <h2><?php echo JText::_("JV_INSTALL_STEP_4_DESC"); ?></h2>
    ...
    <div class="stepContinue">
        ...
        <?php endif; ?>
        <input type="submit" id="adminFormSubmitBtn" value="<?php echo JText::_("JV_NEXT"); ?>" onclick="javascript: jvideo.install.cancelCountdownTimer();" />
        <br /><br />
        <div id="autoNext">
